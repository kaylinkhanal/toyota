  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/hacker.webp?height=1080&width=1920"
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-white/10 rounded-full blur-xl animate-pulse hidden lg:block" />
      <div className="absolute bottom-20 right-20 w-24 h-24 bg-blue-500/20 rounded-full blur-xl animate-pulse hidden lg:block" />
      <div className="absolute top-1/2 left-10 w-16 h-16 bg-purple-500/20 rounded-full blur-xl animate-pulse hidden md:block" />
